...
use mag_core::skills::{
    ...
    SK_DISPEL, SK_DISTRACT, SK_ENHANCE, SK_GASH, SK_GHOST, SK_HEAL, SK_ICE_STUN, SK_IDENT,
    SK_INNER_STRENGTH, SK_LAVA_BLAST, SK_LIGHT, SK_MSHIELD, SK_PARASITE, SK_PROTECT,
    SK_RAINS_OF_RENEWAL, SK_RECALL, SK_REPAIR, SK_REVENANT_CONDUIT, SK_SEEING_RED, SK_STUN,
    SK_SUNS_BLESSING, SK_THUNDEROUS_FURY, SK_WARCRY, SK_WIMPY,
};
